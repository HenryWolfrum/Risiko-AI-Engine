...
public static class RiskMapFactory
{
    public static GameLayout CreateStandardRiskMap(EngineConfig? config = null)
    {
        ...
        var continents = new[]
        {
            new Continent(0, "Nordamerika", 5, 9),
            new Continent(1, "Südamerika", 2, 4),
            new Continent(2, "Afrika", 3, 6),
            new Continent(3, "Europa", 5, 7),
            new Continent(4, "Asien", 7, 12),
            new Continent(5, "Australien", 2, 4)
        };

        //Names
        var territoryNames = new[]
        {
            //North-America
            "Alaska",
        ...
        var territoryToContinent = new byte[]
        {
        ...
        var territoryToType = new[]
        {
            ...
            // Africa (6)
            CardType.Cavalry, CardType.Infantry, CardType.Infantry, CardType.Infantry, CardType.Cavalry,
            CardType.Artillery,
            // Europe (7)
            CardType.Artillery, CardType.Artillery, CardType.Artillery, CardType.Cavalry, CardType.Artillery,
            CardType.Infantry, CardType.Cavalry,
            // Asia (12)
            CardType.Cavalry, CardType.Cavalry, CardType.Cavalry, CardType.Infantry, CardType.Cavalry,
            CardType.Infantry,
            CardType.Infantry, CardType.Infantry, CardType.Cavalry, CardType.Cavalry, CardType.Infantry,
            CardType.Artillery,
            // Australia (4)
